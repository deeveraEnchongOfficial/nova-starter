...
function SidebarTrigger({
    ...
    return (
        <button
            ...
            className={cn(
                "inline-flex h-7 w-7 items-center justify-center rounded-md p-0 text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:size-7 hover:p-0 active:bg-sidebar-accent active:text-sidebar-accent-foreground outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
                className
            )}
            onClick={(event) => {
                onClick?.(event)
            ...
            {...props}
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="size-4">
